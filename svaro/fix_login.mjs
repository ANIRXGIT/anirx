...
import { EyeIcon, EyeSlashIcon, EnvelopeIcon } from '@heroicons/react/24/outline'; // Using generic icons if available, else standard emojis or svgs
      ...
      <div className="max-w-md w-full space-y-8 bg-surface p-8 rounded-3xl border border-border shadow-2xl">
        ...
        <div className="space-y-6">
          ...
          <form onSubmit={handleEmailAuth} className="space-y-4">
            ...
            {/* Hidden submit to handle Enter key properly based on mode */}
